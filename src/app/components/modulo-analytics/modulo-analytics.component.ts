...
@Component({
  ...
  template: `
    <div class="analytics-container fade-in">
      <!-- HEADER / INTRO DEL MÓDULO -->
      <div class="analytics-header">
        <h2>📈 Dashboard Analytics & KPI Executivos</h2>
      ...
      <div class="charts-grid">
        <!-- BAR CHART: COBERTURA INSTITUCIONAL -->
  ...
  `,
  styles: [`
    /* Aplicar la paleta morada de Analytics */
    :host {
      display: block;
    }
    ...
    .kpi-card.kpi-warning {
      border-left-color: #c2760c;
      background-color: rgba(194, 118, 12, 0.04);
    }
...
export class ModuloAnalyticsComponent {
  // Asigna automáticamente el tema 'analytics' (color morado) al host del componente
